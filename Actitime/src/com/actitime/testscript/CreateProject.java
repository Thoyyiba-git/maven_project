...
public class CreateProject {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("http://localhost/login.do");
		 ...
		 driver.findElement(By.id("projectPopup_projectNameField")).sendKeys("qspider");
		 driver.findElement(By.id("projectPopup_customerSelectorPlaceholder")).click();
		 driver.findElement(By.linkText("Media Agency")).click();
		 driver.findElement(By.id("projectPopup_projectDescriptionField")).sendKeys("about qspider students");
